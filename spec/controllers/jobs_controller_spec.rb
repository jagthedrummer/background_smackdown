...
describe JobsController do
  ...
  let(:valid_attributes) { { "batch_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved job as @job" do
        ...
        post :create, {:job => { "batch_id" => "invalid value" }}, valid_session
        expect(assigns(:job)).to be_a_new(Job)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested job" do
        ...
        expect_any_instance_of(Job).to receive(:update).with({ "batch_id" => "1" })
        put :update, {:id => job.to_param, :job => { "batch_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the job as @job" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Job.any_instance.stub(:save).and_return(false)
        put :update, {:id => job.to_param, :job => { "batch_id" => "invalid value" }}, valid_session
        expect(assigns(:job)).to eq(job)
      end
